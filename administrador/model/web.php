...
class Web extends Conectar
{
  ...
  public function cambiar_titulo_uno($negocio, $titulo)
  {
    ...
    if (empty($titulo)) {
      ...
      $sql = "UPDATE web SET titulo_uno = ? WHERE negocio =?";
      $sql = $this->db->prepare($sql);
      $sql->bindValue(1, $titulo);
      $sql->bindValue(2, $negocio);
      $sql->execute();
  ...
  public function cambiar_titulo_dos($negocio, $titulo)
  {
    ...
    if (empty($titulo)) {
      ...
      $sql = "UPDATE web SET titulo_dos = ? WHERE negocio =?";
      $sql = $this->db->prepare($sql);
      $sql->bindValue(1, $titulo);
      $sql->bindValue(2, $negocio);
      $sql->execute();
  ...
  public function hide_modules($negocio, $mision, $vision)
  {
    if (empty($mision) || empty($vision)) {
      ...
      $sql = "UPDATE web SET hide_mision = ?, hide_vision = ? WHERE negocio =?";
      $sql = $this->db->prepare($sql);
      $sql->bindValue(1, $mision);
      $sql->bindValue(2, $vision);
