    ...
    <div class="card overflow-hidden">
      ...
      <div class="card-body">
        ...
        <div class='row'>
          ...
          <div class="col-md-12">
            <div class="from-grup">
              <input type="hidden" name="opcion" value="linkVideo">
              <input type="hidden" name='auto' value='<?php echo $_GET['autoparte'] ?>'>
              <label for="video">Insertar Link de video</label>
              <input type="text" id="linkVideo" name="linkVideo" placeholder="Link video youtube" class="form-control">
            </div>
          </div>
        ...
        <div class="modal-content">
            ...
            <form id="formCrearColor">
                <div class="modal-body">
                    ...
                    <input type="hidden" id='auto' name='auto' value='<?php echo $_GET['autoparte'] ?>'>
                    <div class="row">
                        <div class="col-md-12">
