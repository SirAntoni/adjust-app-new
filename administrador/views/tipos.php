<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    ...
    <div class="d-flex align-items-center flex-wrap text-nowrap">
        <button type="button" data-toggle="modal" data-target="#modalAddTypes"
        ...
        <div class="card overflow-hidden">
            <div class="card-body">
                <div class="table-responsive">
                    <table id="dataTableTypes" class="table table-stripe table-hover table-bordered">
                        <thead>
                            <tr>
                                <th>id</th>
                                <th>Tipo</th>
...
<div class="modal fade" id="modalAddTypes" tabindex="-1" role="dialog" aria-labelledby="modalAddTypes"
    aria-hidden="true">
...
<div class="modal fade" id="modalEditTypes" tabindex="-1" role="dialog" aria-labelledby="modalEditTypes"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="modalDeleteTypes" tabindex="-1" role="dialog" aria-labelledby="modalDeleteTypes"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form id="formDeleteTypes">
                <div class="modal-body">
