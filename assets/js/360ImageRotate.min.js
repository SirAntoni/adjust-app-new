...
function(e) {
	e.fn.TreeSixtyImageRotate = function(t) {
		...
		return n.initTreeSixty = function() {
			n.css({
				height: i.smallHeight,
				width: i.smallWidth,
				position: "relative",
				margin: "auto"
			}), i.spinner && n.spinner("start"), this.loadImages(), i.navigation && n.createNavigation();
			
			let e, t, a = !1, s = !1, l = !1;
			n.find(".images-list").on("mousedown touchstart", function(t) {
			...
			for (let t = 0; t < i.totalFrames + 1; t++) s = e("<li/>").attr({
				class: "images-display image-" + t + (0 === t ? " active" : "")
			}), l = e("<img/>").attr({
				src: i.imagesFolder + i.imgPrefix + t + i.extension
			}), s.append(l), a.append(s);
			t.append(a), n.append(t)
		}, n.createNavigation = function() {
			let t, a, s, l, o, r, c, u;
			t = e("<div/>").attr("class", "navigation-bar-wrapper"), a = e("<div/>").attr("class", "navigation-bar"), s = e("<div/>").attr({
			...
			}), a.append(l), a.append(o), a.append(s), a.append(r), t.append(a), n.append(t), s.on("mousedown touchstart", function(e) {
				e.preventDefault(), c = setInterval(function() {
					n.next()
				}, i.speed)
			}).on("mouseleave mouseup touchend", function() {
				clearInterval(c)
			}), l.on("mousedown touchstart", function(e) {
				e.preventDefault(), u = setInterval(function() {
					n.previous()
				}, i.speed)
			}).on("mouseleave mouseup touchend", function() {
				clearInterval(u)
			...
			o.on("mousedown touchstart", function(e) {
				e.preventDefault(), m ? (n.find(".navigation-bar-play").removeClass("navigation-bar-stop"), m = !1, clearInterval(d)) : (n.find(".navigation-bar-play").addClass("navigation-bar-stop"), m = !0, d = setInterval(function() {
					n.next()
				}, i.speed))
			...
			if (a = e("<div/>").attr({
				...
				t > 991 ? n.find(".loading-spinner").css({
					height : i.smallHeight, width: i.smallWidth
				}): n.find(".loading-spinner").css({
					"max-height": i.largeHeight,
					"max-width": i.largeWidth,
					height: t,
					width: t
				})
			} else "stop" === t ? n.find(".loading-spinner").css({
				display : "none"
			}): console.log("Invalid status for spinner")
		}, n.next = function() {
			let e = n.find(".active"), t = e.attr("class").split(/\s+/)[1], a = parseInt(t.substring(6));
			--a < 0 && (a = i.totalFrames);
			let s = "image-" + a;
			n.find("." + s).addClass("active"), e.removeClass("active")
		}, n.previous = function() {
			let e = n.find(".active"), t = e.attr("class").split(/\s+/)[1], a = parseInt(t.substring(6));
			++a > i.totalFrames && (a = 0);
			let s = "image-" + a;
